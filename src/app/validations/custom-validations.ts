...
//Validacion Personalizada que verifica que el length del arrayControl (el formArray) sea mayor a 1,
...
//Validacion Personalizada que verifica que el length del arrayControl (el formArray) sea menor a 10,
